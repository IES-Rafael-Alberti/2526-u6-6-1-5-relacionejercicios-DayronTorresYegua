...
En la version 0 una misma clase tenia las responsabilidades de preparar lo datos, normalizar y registrar personas, generar informes y hacer los logs
...
Mejora de forma que como cada responsabilidad esta es su sitio si quieres probar o mantener algo puedes ir directamente a la clase en la que esta en vez de tener que mirar dentro de una sola clase y tambien hace mas facil la reutilizacion de cada parte por separado
...
Que obligaba a modificar el enum y el when cada vez que se queria añadir un formato nuevo

2) ¿Qué técnica has usado (polimorfismo/estrategia/jerarquía) para cumplir OCP?

RESPUESTA:

Polimorfismo, creando una interfaz GeneradorInformeV1 que cada formato implementa por separado. Así el código principal solo llama a generar() sin saber qué formato es.

3) ¿Cómo añadirías un nuevo formato tras tu refactor?

RESPUESTA:

Creando una clase nueva que implemente GeneradorInformeV1 y añadiéndola a la lista de generadores en el main, sin tocar ninguna clase existente.
...
RepositorioSoloLecturaV0 era una subclase de RepositorioPersonasV0 pero al intentar guardar lanzaba una excepción. El problema es que cualquiera que usara el padre esperaba poder guardar sin problemas, y al sustituirlo por la subclase el programa se rompía.

2) ¿Qué cambio has hecho para asegurar sustitución válida?

RESPUESTA:

Separar las responsabilidades en interfaces diferentes RepositorioEscritura y RepositorioLEctura, asi RepositorioSoloLectura solo implementa la interfaz RepositorioLectura

3) ¿Cómo lo demostrarías con una prueba/ejemplo?

RESPUESTA:

En la v0 el error lo descubres cuando ejecutas el programa y explota. En la v1 el propio compilador te avisa antes de ejecutar si intentas usar el repositorio de solo lectura donde se necesita escritura, es decir, el error se detecta antes.
...
- 
  Antes:
  https://github.com/IES-Rafael-Alberti/2526-u6-6-1-5-relacionejercicios-DayronTorresYegua/blob/8a4bf9f668653172c53e7cc986252e52f8eae7da/src/main/kotlin/es/ies/ejercicios/u6/ej65/srp/SrpV0.kt#L1-L47

  Despues:
  https://github.com/IES-Rafael-Alberti/2526-u6-6-1-5-relacionejercicios-DayronTorresYegua/blob/698fe2534434bc21bba4ab840492955d251c41ae/src/main/kotlin/es/ies/ejercicios/u6/ej65/srp/SrpV1.kt#L1-L76
  
- Cambios OCP (cómo añades el nuevo formato).

  https://github.com/IES-Rafael-Alberti/2526-u6-6-1-5-relacionejercicios-DayronTorresYegua/blob/da78a496d66bad9d853a5c60147f0131e5fc2f01/src/main/kotlin/es/ies/ejercicios/u6/ej65/ocp/OcpV1.kt#L1-L55
  
- Cambios LSP (dónde se arregla la sustitución).

  https://github.com/IES-Rafael-Alberti/2526-u6-6-1-5-relacionejercicios-DayronTorresYegua/blob/158149e640d120322aeb184d628d6de54dd77bcf/src/main/kotlin/es/ies/ejercicios/u6/ej65/lsp/LspV1.kt#L12-L21
  https://github.com/IES-Rafael-Alberti/2526-u6-6-1-5-relacionejercicios-DayronTorresYegua/blob/158149e640d120322aeb184d628d6de54dd77bcf/src/main/kotlin/es/ies/ejercicios/u6/ej65/lsp/LspV1.kt#L31-L35
...
![Salida SRP](../../assets/principioSrpSalida.png)

Principio OCP:

![Salida OCP](../../assets/principioOcpSalida.png)

Principio LSP:

![Salida LSP](../../assets/principioLspSalida.png)
